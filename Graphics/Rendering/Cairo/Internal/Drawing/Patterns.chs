...
{#fun pattern_create_rgb          as patternCreateRGB        { `Double', `Double', `Double' } -> `Pattern' id#}
{#fun pattern_create_rgba         as patternCreateRGBA       { `Double', `Double', `Double', `Double' } -> `Pattern' id#}
{#fun pattern_create_for_surface  as patternCreateForSurface { withSurface* `Surface' } -> `Pattern' id#}
{#fun pattern_create_linear       as patternCreateLinear     { `Double', `Double', `Double', `Double' } -> `Pattern' id#}
{#fun pattern_create_radial       as patternCreateRadial     { `Double', `Double', `Double', `Double', `Double', `Double' } -> `Pattern' id#}
{#fun pattern_destroy    as patternDestroy   { unPattern `Pattern' } -> `()'#}
{#fun pattern_reference  as patternReference { unPattern `Pattern' } -> `Pattern' id#}
...
{#fun pattern_set_matrix as patternSetMatrix { unPattern `Pattern', withMatrix* `Matrix' } -> `()'#}
